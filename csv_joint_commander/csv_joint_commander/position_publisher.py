...
class PositionPublisher(Node):
    def __init__(self):
        ...
        if not csv_file:
            ...
            csv_file = os.path.join(home, 'Documents', 'demo_pickup.csv')
        ...
        # Auto-detect joints
        keywords = ['joint', 'slider']
        self.joint_names = [col for col in self.data.columns 
                    if any(keyword in col.lower() for keyword in keywords)]
        #if not self.joint_names:
        #    self.joint_names = ['joint_1', 'joint_2', 'joint_3', 'joint_4', 'joint_5', 'joint_6', 'Slider 22', 'Slider 23']
